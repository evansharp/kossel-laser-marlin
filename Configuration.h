...
#define CUSTOM_MENDEL_NAME "CMA-kerbot (M-Kit)"
...
#define DELTA_DIAGONAL_ROD 218.6// mm stock: 218.0

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 150.1// mm stock: 151.0

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 24.0 // mm stock: 24.0

// Horizontal offset of the universal joints on the carriages.
#define DELTA_CARRIAGE_OFFSET 22.0 // mm //stock: 22.0
...
#define ENABLE_AUTO_BED_LEVELING // Auto-leveling feature is turned on or not. 
  ...
  #define DELTA_PROBABLE_RADIUS (DELTA_PRINTABLE_RADIUS-60)//Here the probe is set to leveling the range of movement,Increasing the leveling range, reduce the "-50" This value,Reducing leveling range, increase the "-50" value
...
#define MANUAL_Z_HOME_POS 290.0//270//306.6 // For delta: Distance between nozzle and print surface after homing.
